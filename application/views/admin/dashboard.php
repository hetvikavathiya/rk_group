...
<div class="card mt-3">
  	...
  	<div class="card mt-3">
 	     <div class="card-content">
            ...
            <div class="col-12 col-lg-6 col-xl-3 border-light">
                <div class="card-body">
                  <h5 class="text-white mb-0"><?php if(!empty($total_recovery['installment_amount'])){echo $total_recovery['installment_amount'];}else{echo '0';};?> <span class="float-right"><i class="zmdi zmdi-assignment-check"></i></span></h5>
                    <div class="progress my-3" style="height:3px;">
                       <div class="progress-bar" style="width:55%"></div>
                    </div>
            ...
            <div class="col-12 col-lg-6 col-xl-3 border-light">
                <div class="card-body">
                  <h5 class="text-white mb-0"><?php if(!empty($total_recovery_pending['installment_amount'])){echo $total_recovery_pending['installment_amount'];}else{echo '0';};?> <span class="float-right"><i class="zmdi zmdi-balance"></i></span></h5>
                    <div class="progress my-3" style="height:3px;">
                       <div class="progress-bar" style="width:55%"></div>
                    </div>
