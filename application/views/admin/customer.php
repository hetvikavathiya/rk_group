<div class="row mt-3">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <div class="card-title">Customer <?php if (!empty($row_data)) {
                                                        echo 'Edit';
                                                    } ?></div>
                <hr>

                <form method="post" action="<?php if (!empty($row_data)) {
                                                echo base_url('admin/customer/update/') . $row_data['id'];
                                            } else {
                                                echo base_url('admin/customer/add');
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <input type="text" value="<?php if (!empty($row_data)) {
                                                            ...
                                                            } ?>" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')" pattern=".{10,}" minlength="12" maxlength="12" class="form-control" id="input-3311" name="aadhar_card" placeholder="Enter Aadhaar Card No" required>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group">
                        ...
                        <div class="col-lg-4">
                            ...
                            <select class="form-select" id="select" name="document_type" aria-label="Default select example">
                                ...
                                <option value="Aadhaar Card" <?php if (!empty($row_data) && $row_data['document_type'] == 'Aadhaar Card') {
                                                                    echo 'selected';
                                                                } ?>>Aadhaar Card</option>
                                <option value="Pan Card" <?php if (!empty($row_data) && $row_data['document_type'] == 'Pan Card') {
                                                                echo 'selected';
                                                            } ?>>Pan Card</option>
                                <option value="Election card" <?php if (!empty($row_data) && $row_data['document_type'] == 'Election card') {
                                                                    echo 'selected';
                                                                } ?>>Election card</option>
                                <option value="Driving Licence" <?php if (!empty($row_data) && $row_data['document_type'] == 'Driving Licence') {
                                                                    echo 'selected';
                                                                } ?>>Driving Licence</option>
                                <option value="Passport" <?php if (!empty($row_data) && $row_data['document_type'] == 'Passport') {
                                                                echo 'selected';
                                                            } ?>>Passport</option>
                                <option value="Other" <?php if (!empty($row_data) && $row_data['document_type'] == 'Other') {
                                                            echo 'selected';
                                                        } ?>>Other</option>
                            </select>
                        </div>
                        ...
                        <div class="col-lg-4 py-2">
                            ...
                            <select class="form-select" id="select121" name='status' aria-label="Default select example">
                                ...
                                <option value="Approved" <?php if (!empty($row_data) && $row_data['status'] == 'Approved') {
                                                                echo 'selected';
                                                            } ?>>Approved</option>
                                <option value="Pending" <?php if (!empty($row_data) && $row_data['status'] == 'Pending') {
                                                            echo 'selected';
                                                        } ?>>Pending</option>
                                <option value="Rejected" <?php if (!empty($row_data) && $row_data['status'] == 'Rejected') {
                                                                echo 'selected';
                                                            } ?>>Rejected</option>
                            </select>
                        </div>
