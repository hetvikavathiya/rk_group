        ...
        <?php $this->session->set_flashdata('flash_message', "");
                ...
                <div class="form-group">
                  ...
                  <div class="position-relative has-icon-right">
                    <input type="text" id="exampleInputUsername" required onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')" pattern=".{10,}"   minlength="10" maxlength="10"  name="mobile_no" autocomplete="off" class="form-control input-shadow"
                ...
                <div class="form-group">
                  ...
                  <div class="position-relative has-icon-right">
                    <input type="password" id="exampleInputPassword" name='password' required class="form-control input-shadow"
