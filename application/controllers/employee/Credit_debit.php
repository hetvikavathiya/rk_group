...
class Credit_debit extends CI_Controller {
    ...
    function __construct()
	{
		...
		if ($this->session->userdata('loginstatus') != 2 || $this->session->userdata('admin_id') == "" && ($this->session->userdata('user_type') != "employee") || (!in_array("Credit-Debit", $array_permission))) {
	...
	public function close($param = ''){
        ...
        redirect(base_url("employee/credit_debit/profile/".$customer_id),'refresh');
	}
