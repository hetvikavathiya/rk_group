...
class Loan extends CI_Controller
{
	...
	public function create($customer_id)
	{
		...
		$this->form_validation->set_rules('aadhar_card', 'aadhar_card', 'trim|required|max_length[12]');
		$this->form_validation->set_rules('name_2', 'name_2', 'trim|required');
		$this->form_validation->set_rules('mobile_2', 'mobile_2', 'trim|required|max_length[10]');
		$this->form_validation->set_rules('aadhar_card_2', 'aadhar_card_2', 'trim|required|max_length[12]');
		$this->form_validation->set_rules('s_date', 's_date', 'trim|required');
		$this->form_validation->set_rules('e_date', 'e_date', 'trim|required');
		$this->form_validation->set_rules('loan_type_id', 'loan_type_id', 'trim|required');
		$this->form_validation->set_rules('loan_amount', 'loan_amount', 'trim|required');
		$this->form_validation->set_rules('loan_interest', 'loan_interest', 'trim|required');
		$this->form_validation->set_rules('fixed_charge', 'fixed_charge', 'trim|required');
		$this->form_validation->set_rules('payable_amount', 'payable_amount', 'trim|required');
		$this->form_validation->set_rules('installment_date[]', 'installment_date', 'trim|required');
		$this->form_validation->set_rules('installment_amount[]', 'installment_date', 'trim|required');
		...
		if ($this->form_validation->run() == false) {
			...
			$loan['loan_type_id'] = $post_request['loan_type_id'];
